...
{
    [TestFixture]
    public class BlockCommentCommandHandlerTests
    {
        [Test]
        public void Constructor_WithValidArguments_CreatesInstance()
        {
            ...
            //Act
            var blockCommentCommand = new BlockCommentCommand(rentalBookId);

            //Assert
            Assert.That(blockCommentCommand.RentalBookId, Is.EqualTo(rentalBookId));
        }
        ...
        public async Task Handle_ValidCommand_ReturnsSuccessResult()
        {
            ...
            rentalBookRepository.Setup(repo => repo.GetReader(rentalId)).ReturnsAsync(reader);
            ...
            var command = new BlockCommentCommand(rentalBookId);
            var handler = new BlockCommentCommandHandler(rentalBookRepository.Object, outboxRepository.Object);
        ...
        [Test]
        public async Task Handle_AlreadyBlocked_ReturnsFailureResult()
        {  //Arrange
            var rentalBookId = Guid.NewGuid();
            var rentalId = Guid.NewGuid();
            var bookId = Guid.NewGuid();
            ...
            //Assert 
            Assert.IsFalse(result.IsSuccess);
            Assert.That(result.ErrorMessage, Is.EqualTo("This comment already is blocked."));
        }
    }
}
