...
{
    [TestFixture]
    public class UnblockOwnerCommandHandlerTests
    {
        [Test]
        public void Constructor_WithValidArguments_CreatesInstance()
        {
            ...
            //Act
            var command = new UnblockOwnerCommand(username);
        ...
        public async Task Handle_ValidCommand_ReturnsSuccessResult()
        {
            ...
            var command = new UnblockOwnerCommand(username);
            var handler = new UnblockOwnerCommandHandler(ownerRepository.Object, libraryRepository.Object);
